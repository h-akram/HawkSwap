...
sudo systemctl enable ~/2021-team06r/sprint-03/code/django/django-server.servicedjango-server.service
sudo systemctl start ~/2021-team06r/sprint-03/code/django/django-server.servicedjango-server.service
