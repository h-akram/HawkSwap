...
sed -i "s/\$ACCESSFROMIP/127.0.0.1/g" ~/2021-team06r/sprint-03/code/db-samples/*.sql
sed -i "s/\$USERPASS/$USERPASS/g" ~/2021-team06r/sprint-03/code/db-samples/*.sql
sed -i "s/\$MMIP/127.0.0.1/g" ~/2021-team06r/sprint-03/code/db-samples/*.sql
...
sudo mysql -u root < ~/2021-team06r/sprint-03/code/db-samples/create-table.sql
...
sudo mysql -u root < ~/2021-team06r/sprint-03/code/db-samples/insert-records.sql
# This script will select * from comments and print the contents to the screen to make sure it all worked
sudo mysql -u root < ~/2021-team06r/sprint-03/code/db-samples/sample-select.sql
