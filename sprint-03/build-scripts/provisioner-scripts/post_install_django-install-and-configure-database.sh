...
sed -i "s/\$ACCESSFROMIP/$ACCESSFROMIP/g" ~/2021-team06r/sprint-03/code/db-samples/*.sql
sed -i "s/\$USERPASS/$USERPASS/g" ~/2021-team06r/sprint-03/code/db-samples/*.sql
sed -i "s/\$DATABASENAME/$DATABASENAME/g" ~/2021-team06r/sprint-03/code/db-samples/*.sql
##############################################################################################
