...
# Run SQL command
sed -i "s/\$ACCESSFROMIP/$ACCESSFROMIP/g" ~/2021-team06r/sprint-03/code/db-samples/create-user-with-permissions-sample.sql
sed -i "s/\$USERPASS/$USERPASS/g" ~/2021-team06r/sprint-03/code/db-samples/create-user-with-permissions-sample.sql
